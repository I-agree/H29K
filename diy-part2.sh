...
# 清理可能引发覆盖的冲突条目
sed -i '/CONFIG_EMAC_ROCKCHIP/d; /CONFIG_ARM64_PA_BITS/d; /CONFIG_CMA_SIZE_MBYTES=16/d; /CONFIG_CRYPTO_HW/d; /CONFIG_CRYPTO_DEV_/d; /CONFIG_CRYPTO_AKCIPHER/d; /CONFIG_CRYPTO_KPP/d; /CONFIG_DEFAULT_NET_CONG/d; /CONFIG_DEFAULT_BBR/d; /CONFIG_ARM64_SVE/d; /CONFIG_BT/d; /CONFIG_DRM_/d; /CONFIG_FB_/d; /CONFIG_BACKLIGHT_/d; /CONFIG_SPI/d; /CONFIG_MEDIA/d; /CONFIG_VIDEO/d; /CONFIG_USB_VIDEO_CLASS/d' "$CONFIG_FILE" 2>/dev/null || true
...
# PWM 调节器采用连续工作模式
CONFIG_REGULATOR_PWM_CONTINUOUS=y
