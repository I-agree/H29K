...
CONFIG_DRM_PANEL_ROCKCHIP=y
CONFIG_DMA_SHARED_BUFFER=y
CONFIG_CMA_SIZE_MBYTES=320

# --------------------------
# 4. 音频硬件 I2S/PDM/SPDIF
# --------------------------
CONFIG_SND=y
CONFIG_SND_SOC=y
...
# 2. 自动验证 IMAGE 行是否正确
grep -q "boot-common | boot-script | append-rootfs | pad-rootfs | gzip" target/linux/rockchip/image/Makefile
