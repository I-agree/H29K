...
download_and_check "${BASE_URL}/package/boot/uboot-rockchip/patches/903-fix-binman-split-elf-optional.patch" "package/boot/uboot-rockchip/patches/903-fix-binman-split-elf-optional.patch"
